...
public class Cube {
	...
	public String generateCubeSQLString(){
		...
		for(Dimension d : dimensions){
			olapQueryString += d.tableName() + "," + br; //tableName,
		}
		...
		for(Dimension d : dimensions){
			olapQueryString +=  d.tableName() + "." + d.keyName() + " = " + fact.tableName() + "." + d.keyName() + " AND" + br; //tableName.keyName = factTableName.dimensionKeyName
		}
